//A REGLER : pb remplacment curseur par image debloquee + ajout option changment niveau/fond d'écran
...
//calcul points aléatoires par clic
function ajoute() {
	jeu;
